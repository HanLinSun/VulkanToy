...
//This code is based on Vulkan example from Sascha willams
// C++ 11 based threadpool
...
namespace Renderer
{
	...
	private:
		...
		//these new features are in C++ 11
		std::thread worker;
	...
	public:
		...
		//Add a new job to thee thread's queue
